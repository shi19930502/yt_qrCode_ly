...
function renderXsjlList(data) {
    ...
    for (var m = 0; m < data.length; m++) {
        ...
        if (m >= 1) {
            for (var n = 1; n < 2; n++) {
                htmlStr_left = '<li>' + '<span class="yellow_spot ani" swiper-animate-effect="bounceInDown" swiper-animate-duration="1s" swiper-animate-delay=' + animateC + 's></span>' + '<div class="text ani" swiper-animate-effect="bounceInLeft" swiper-animate-duration="1s" swiper-animate-delay=' + animateT + 's>' + '<p>批次号</p>' + '<p class="span">' + data[m][arr[m]].batchId + '</p>' + '<p>交易凭证号</p>' + '<p class="span">' + data[m][arr[m]].transId + '</p>' + '</div>' + '</li>';
